...
const COMPARISON_ROWS: ComparisonRow[] = [
  { feature: "Smart Matching", sam: "Manual keyword search", samStatus: "no", cp: "Auto-matched to your profile", cpStatus: "yes" },
  { feature: "Scoring", sam: "None", samStatus: "no", cp: "140-point algorithm", cpStatus: "yes" },
  { feature: "Proposal Help", sam: "None", samStatus: "no", cp: "AI Proposal Writer", cpStatus: "yes" },
  { feature: "Eligibility Check", sam: "Manual research", samStatus: "no", cp: "Instant verification", cpStatus: "yes" },
  { feature: "Alerts", sam: "Basic email (often missed)", samStatus: "partial", cp: "Smart alerts with scoring", cpStatus: "yes" },
  { feature: "Interface", sam: "Government legacy UI", samStatus: "no", cp: "Modern SaaS dashboard", cpStatus: "yes" },
  { feature: "Capability Statement", sam: "None", samStatus: "no", cp: "Voice-powered builder", cpStatus: "yes" },
  { feature: "Price", sam: "Free", samStatus: "yes", cp: "$199/mo", cpStatus: "text" },
  { feature: "Data Source", sam: "Direct (official)", samStatus: "yes", cp: "Same SAM.gov data", cpStatus: "yes" },
  { feature: "Learning Curve", sam: "Steep (weeks)", samStatus: "no", cp: "5 minutes", cpStatus: "yes" },
];
...
/* ------------------------------------------------------------------ */
/*  CapturePilot Mockup (right side)                                   */
/* ------------------------------------------------------------------ */
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-stone-50 to-white py-24 md:py-32">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg sm:text-xl text-stone-500 leading-relaxed max-w-2xl mx-auto animate-fade-in-up animate-delay-200">
              ...
              is the intelligence layer on top &mdash; same data, scored, matched,
              and ready to act on.
            </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
                Same Data,{" "}
                <span className="gradient-text">Completely Different Experience</span>
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="animate-fade-in-up">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-stone-700">SAM.gov</p>
                    <p className="text-[10px] text-stone-400 uppercase tracking-wider">Manual Search</p>
                  </div>
                </div>
                <SamMockup />
                <p className="text-xs text-stone-400 mt-3 text-center italic">
              ...
              <div className="animate-fade-in-up animate-delay-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-stone-700">CapturePilot</p>
                    <p className="text-[10px] text-emerald-600 uppercase tracking-wider font-medium">Smart Dashboard</p>
                  </div>
                </div>
                <CpMockup />
        ...
        {/* ============================================================ */}
        {/*  WE DON'T REPLACE SAM.GOV                                    */}
        {/* ============================================================ */}
        <section className="py-24 bg-white">
          <div className="max-w-4xl mx-auto px-6">
            <div className="bg-gradient-to-br from-stone-50 to-amber-50/40 border border-stone-200 rounded-2xl p-8 md:p-12 animate-fade-in-up">
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                <p>
                  SAM.gov is the <strong className="text-stone-800">official system of record</strong> for
                ...
                <p>
                  What CapturePilot does is sit <strong className="text-stone-800">on top</strong> of
                ...
                <p>
                  Think of it this way: <strong className="text-stone-800">SAM.gov is the library.
              ...
              <div className="grid sm:grid-cols-3 gap-4 mt-8">
                {[
                  { icon: Shield, label: "SAM.gov remains your official registration", color: "text-blue-600 bg-blue-50" },
                  { icon: BarChart3, label: "We add scoring, matching & intelligence", color: "text-emerald-600 bg-emerald-50" },
                  { icon: FileText, label: "Plus proposal tools SAM.gov will never have", color: "text-purple-600 bg-purple-50" },
                ].map((item, i) => {
                  const Icon = item.icon;
                  return (
                    <div key={i} className="flex items-start gap-3 bg-white rounded-xl border border-stone-200 p-4">
                      <div className={`w-9 h-9 rounded-lg ${item.color.split(" ")[1]} flex items-center justify-center shrink-0`}>
                        <Icon className={`w-4.5 h-4.5 ${item.color.split(" ")[0]}`} />
                      </div>
                      <p className="text-xs text-stone-600 leading-relaxed font-medium">{item.label}</p>
                    </div>
                  );
                })}
              </div>
        ...
        <section className="py-16 bg-white border-t border-stone-100">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {[
                { label: "GovWin", href: "/vs/govwin" },
                { label: "GovTribe", href: "/vs/govtribe" },
                { label: "BGOV", href: "/vs/bgov" },
                { label: "HigherGov", href: "/vs/highergov" },
              ].map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
        ...
        <section className="py-24 bg-gradient-to-b from-white to-stone-50">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href={CHECK_URL}
                className="inline-flex items-center justify-center gap-2 border border-emerald-300 text-emerald-700 bg-emerald-50 px-8 py-4 rounded-full font-bold text-base hover:bg-emerald-100 transition-colors"
              >
