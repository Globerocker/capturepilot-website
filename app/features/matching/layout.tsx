...
export const metadata: Metadata = {
  title: "Smart Matching Engine — Find Contracts You Can Win | CapturePilot",
  ...
  alternates: { canonical: "https://capturepilot.com/features/matching" },
  openGraph: {
    title: "Smart Matching Engine — Find Contracts You Can Win | CapturePilot",
    description: "CapturePilot's proprietary matching engine scores 40,000+ federal opportunities against your NAICS codes, certifications, and location. See your best matches daily.",
    url: "https://capturepilot.com/features/matching",
  },
};
